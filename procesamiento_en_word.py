...
logger_word = logging.getLogger("Resumen_Exportaciones")
...
def generar_docx(vars_from_totales:dict,vars_from_no_mineras: dict,vars_from_mes_ano:dict)-> Document:
    ...
    doc = Document()
    logger_word.info("Documento de Word inicializado.")
...
#0. Resumen Inicial
    ...
    try:    
        ...
        logger_word.info("Resumen inicial procesado exitosamente .")
...
#1.     Top 10 destinos de la exportación no minero energética y las empresas.
   ...
   #     Procesamiento de los datos, se hace con un for sobre los valores de los diccionarios.
        ...
        logger_word.info("Se generó el resumen de los destinos")
...
# 2.     Top 10 empresas exportadoras no minero energéticas Enero -mes actual, año actual
        ...
        logger_word.info("Se generó el resumen de las empresas")
 ...
 # 3    . Top 10 productos exportados no minero energéticos Enero -mes actual, año actual
        ...
        logger_word.info("Se generó el resumen de los productos")
...
#4.     Análisis por depatamentos
        ...
        logger_word.info("Se generó el resumen de los departamentos")
...
#6.     Analisis de Venezuela:
        ...
        logger_word.info("Se generó el resumen de Venezuela")
        return doc
